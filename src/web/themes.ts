 ...
 *
 * Trente-six palettes, une seule forme : chacune renseigne les mêmes dix
 ...
 *
 * Nommé, et non « le premier de la liste » : les palettes sont rangées par
 * teinte pour se lire en grille, et ce rangement ne doit pas décider de ce
 * qu'on voit au premier lancement. Ajouter un rouge sombre changeait le
